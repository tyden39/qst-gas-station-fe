...
const SelectTrigger = React.forwardRef(
  ({ className, children, value, onClose, disabled, ...props }, ref) => (
    <div className="relative">
      ...
      {value ? (
        <SelectPrimitive.Icon className="absolute top-1/2 -translate-y-1/2 right-3">
          <X
            className={cn("h-4 w-4 opacity-50", disabled ? "cursor-not-allowed" : "hover:bg-destructive hover:stroke-destructive-foreground hover:opacity-75 rounded cursor-pointer")}
            onClick={onClose}
          />
        </SelectPrimitive.Icon>
      ) : null}
